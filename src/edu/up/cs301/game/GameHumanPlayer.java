...
import edu.up.cs301.hex.HexGrid;
...
public abstract class GameHumanPlayer implements GamePlayer, Tickable {
	 ...
	 */
	public final void tick(GameTimer timer, Canvas g) {
...
//
//					Path thisHex = new Path();
//					for(int q = 0; q < mCornersX.length; ++q)
//					{
//						thisHex.addPath(thisHex,mCornersX[q], mCornersY[q]);
//					}
//
//					Paint p = new Paint();
//					p.setColor((mCells[j][i] == L_ON) ? Color.MAGENTA : Color.GRAY);
//					g.drawPath(thisHex,p);
//					//                    p.setColor(Color.BLACK);
//					//                    c.drawPath(thisHex,p);
//					
//				}
//			}
//		}
